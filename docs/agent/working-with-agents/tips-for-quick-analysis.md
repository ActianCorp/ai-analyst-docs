...
Your Actian AI Analyst agent can handle a wide variety of data-related requests:

* **Data Exploration**: "What sort of analyses can you do about our shipment data? Give me some ideas."
* **Specific Visualizations**: "Create a line chart showing monthly revenue trends for 2025"
* **Lookup Information**: "What's the delivery status of order #12345?"
* **Comparative Analysis**: "Compare the total revenue across all available regions for Q1 vs Q2 2025, specifically for our premium products"
...
By following these guidelines, you can leverage your custom Actian AI Analyst agent to gain meaningful insights and make informed data-driven decisions.
